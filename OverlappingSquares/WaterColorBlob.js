...
function WaterColorBlob()
{
    ...
    this.CreatePolygon = function (position, size, numberOfPoints,rotation)
    {
        this.size = size; 
        this.polygonPoints = polygon(position, size, numberOfPoints, rotation);
    ...
    this.ShowLayers = function()
    {
        ...
        for(let i = 0; i < this.layers.length; i++)
        {
            ...
            this.c.setAlpha(Math.abs(randomGaussian(10,5)));
            fill(this.c);
            noStroke(); 
            beginShape()
